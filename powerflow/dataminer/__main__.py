...
# TODO: Proper Option system AS PART OF Modularization!
# Put that into the meta-package
# Should support exporting filtered variants of data
...
# TODO: Do this automatically if the fetched DB is newer than the agg
# and also if the agg doesn't exist yet
prep_gens = False
if (prep_gens):
